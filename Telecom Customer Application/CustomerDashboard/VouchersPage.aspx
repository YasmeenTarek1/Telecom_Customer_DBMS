...
<head runat="server">
    ...
    <style>
       .voucher-details {
        ...
        .coupon:hover { transform: scale(1.02); }
        ...
        .left { width: 20%; border-right: 3px dashed rgba(0,0,0,0.13); display: flex; align-items: center; justify-content: center; }
        .left div { transform: rotate(-90deg); white-space: nowrap; font-weight: bold; color: #000; font-size: 1.5rem; font-family: Merriweather, sans-serif;}
        .center { flex-grow: 1; text-align: center; display: flex; align-items: center; flex-direction: column; }
        .center h2 { background: #000; color: gold; padding: 5px 10px; font-size: 3rem; }
        .center h3 { font-size: 2rem; color: #000; margin-top: -10px; }
        .center small { font-size: 1.1rem; color: #000; margin-top: -10px; }
        .right { width: 120px; background-image: radial-gradient(circle at 100% 50%, transparent 25px, #fff 26px); display: flex; align-items: center; justify-content: center; }
        .right div {
        ...
        @media (max-width: 768px) { 
            .voucher-container { flex-direction: column; }
            .voucher-list, .voucher-details { width: 100%; position: static; margin: 20px 0; }
            .coupon { height: auto; padding: 20px; }
            .left div, .right div { transform: rotate(0deg); }
        }
    </style>
</head>
<body>
