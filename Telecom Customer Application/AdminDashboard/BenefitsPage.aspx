        ...
        <div class="container" runat="server">
            ...
            <div id="sharedContent" class="tab-content">
                ...
                <div class="PlanCardsContainer" runat="server">
                    <!-- Total Benefits Card -->
                    <div class="plan-card basic-plan" id="total-benefits-card" style="padding: 35px 25px; height: 170px;">
                    ...
                    <!-- Points Card -->
                    <div class="plan-card  standard-plan" id="points-card" style="padding: 35px 25px; height: 170px;">
                    ...
                    <!-- Cashback Card -->
                    <div class="plan-card premium-plan" id="cashback-card" style="padding: 35px 25px; height: 170px;">
                    ...
                    <div class="plan-card unlimited-plan" id="exclusive-offers-card" style="padding: 35px 25px; height: 170px;">
                        <i class="fas fa-gift"></i>
                        <div class="plan-name">Exclusive Offers</div>
                        <div class="plan-details" style="margin-bottom: 0px;">SMS, data, and internet bundles</div>
