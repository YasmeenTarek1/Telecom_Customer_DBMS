<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PaymentsPage.aspx.cs" Inherits="Telecom_Customer_Application.AdminDashboard.PaymentsPage" %>
    ...
    <form id="form1" runat="server">
        <div class="container" runat="server">
            ...
            <div id="sharedContent" class="tab-content">
                ...
                <h3 id="TabHeading" class="tab-heading">Payments</h3>
